...
<section>
    <div class="mb-6 py-4 bg-white rounded">
        <div class="flex px-6 pb-4 border-b">
            ...
            <div class="ml-auto">
                <a href="recipis/create" class="py-2 px-3 text-xs text-white font-semibold bg-indigo-500 rounded-md">新規投稿</a>
            </div>
        </div>
            ...
            <table class="table-auto w-full">
                ...
                <tbody>
                    ...
                    <td class="flex px-4 py-3 recipis-center">
                        <img class="w-12 h-12 mr-4 object-cover rounded-md" src="{{ asset('recipis'.$recipi->image) }}" alt="">
                    ...
                    <td>
                        <div class="flex">
                            ...
                            <form action="{{ route('admin.recipis.destroy',['recipi' => $recipi->id]) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button>
