...
<a class="inline-block flex justify-center px-4 py-3 text-xs font-semibold leading-none bg-green-500 hover:bg-green-600 text-white rounded" href="/project">戻る</a>
@if(isset($recipis))
